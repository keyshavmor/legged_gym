...
class HistoryWrapper(gym.Wrapper):
    def __init__(self, env):
        ...
        self.obs_history = torch.zeros(self.env.cfg.env.num_envs, self.num_obs_history, dtype=torch.float,
    ...
    def step(self, action):
        ...
        obs, privileged_obs, rew, done, info = self.env.step(action)  #by why
